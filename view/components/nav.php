                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
											            ...
											            <li>
												            <div class="timeline-panel">
													            ...
													            <div class="media-body">
														            <h6 class="mb-1">Payment: $1200</h6>
														            <small class="d-block">29 July 2020 - Venue</small>
													            </div>
												            </div>
											            </li>
											            <li>
                                      ...
                                      <div class="media me-2 media-success">
												              ...
												              <div class="media-body">
												          	    <h6 class="mb-1">Income: $3000</h6>
												          	    <small class="d-block">29 July 2020 - Horses</small>
												              </div>
                                    </div>
											            </li>
														    </ul>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              ...
                              <a href="controller/doLogout.php" class="dropdown-item ai-icon">
          ...
          <div class="dlabnav-scroll">
            <div class="dropdown header-profile2 ">
             ...
             <li>
              ...
              <p><strong>Budget Manager</strong> © 2021 All Rights Reserved</p>
              <p class="fs-12">El Lugar - by RAI</p>
            </div>
          </div>
        </div>
